    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 bg-[radial-gradient(#d1d5db_1.5px,transparent_1.5px)] [background-size:24px_24px]">
      ...
      <main>
        ...
        <section className="px-4 py-16"><div className="mx-auto max-w-4xl rounded-xl border border-gray-200 bg-white/80 p-6 backdrop-blur-sm md:p-8"><h2 className="mb-8 text-center text-2xl font-bold">What You&apos;re Getting</h2><div className="flex flex-col items-center gap-8 md:flex-row">
          ...
          <ul className="w-full divide-y divide-gray-200 text-sm md:w-3/5 md:text-base"><li className="flex justify-between py-3"><span className="text-gray-500">Output voltage</span><strong>5V / 9V / 12V</strong></li><li className="flex justify-between py-3"><span className="text-gray-500">Battery type</span><strong>Rechargeable lithium</strong></li><li className="flex justify-between py-3"><span className="text-gray-500">Compatible with</span><strong>Most home routers and modems</strong></li><li className="flex justify-between py-3"><span className="text-gray-500">Delivery</span><strong>Nationwide</strong></li></ul>
        </div></div></section>

        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-md">
          <div className="bg-white rounded-2xl p-6 md:p-8 max-w-md w-full shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <div className="space-y-4 text-sm md:text-base text-gray-700 text-center">
              ...
              <p>To help us serve our customers better, we kindly ask that you only submit this order if you are ready to receive and pay for your 3-in-1 Portable Vacuum Cleaner upon delivery.</p>
              ...
              <p className="text-green-600 font-semibold">If you are ready to receive and pay for your vacuum cleaner upon delivery, click Yes to continue.</p>
            </div>
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between p-3 md:p-4 border border-gray-200 rounded-lg cursor-pointer bg-white hover:border-orange-600 transition-colors">
              <div className="flex items-center gap-3">
                <input type="radio" name="Quantity" value="1 Unit (₦30,000)" required className="w-4 h-4 text-orange-600" defaultChecked />
                <span className="font-medium text-sm md:text-base text-gray-700 uppercase">Buy 1 Vacuum Cleaner</span>
              </div>
              <span className="font-bold text-orange-600">₦30,000</span>
            </label>
            ...
            <label className="flex items-center justify-between p-3 md:p-4 border border-orange-300 rounded-lg cursor-pointer relative bg-orange-50/30 hover:border-orange-600 transition-colors">
              <div className="flex items-center gap-3">
                <input type="radio" name="Quantity" value="2 Units (₦60,000)" required className="w-4 h-4 text-orange-600" />
                <span className="font-medium text-sm md:text-base text-gray-700 uppercase">Buy 2 Vacuum Cleaners</span>
              </div>
              <div className="flex items-center gap-2">
                 <span className="font-bold text-orange-600">₦60,000</span>
              </div>
            </label>
          </div>
        </div>
